...
-- CreateIndex
CREATE UNIQUE INDEX "PostEngagement_postId_key" ON "PostEngagement"("postId");

-- CreateIndex
CREATE INDEX "PostEngagement_engagementScore_idx" ON "PostEngagement"("engagementScore");

-- CreateIndex
CREATE INDEX "UserInteraction_userId_idx" ON "UserInteraction"("userId");

-- CreateIndex
CREATE INDEX "UserInteraction_affinityScore_idx" ON "UserInteraction"("affinityScore");

-- CreateIndex
CREATE UNIQUE INDEX "UserInteraction_userId_targetUserId_key" ON "UserInteraction"("userId", "targetUserId");
...
-- AddForeignKey
ALTER TABLE "UserInteraction" ADD CONSTRAINT "UserInteraction_targetUserId_fkey" FOREIGN KEY ("targetUserId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
